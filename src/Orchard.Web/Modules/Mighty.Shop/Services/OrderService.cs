...
namespace Mighty.Shop.Services
{
    public class OrderService : IOrderService
    {
        ...
        public OrderService(IDateTimeService dateTimeService, IRepository<ProductPartRecord> productRepository, IContentManager contentManager, IRepository<OrderRecord> orderRepository, IRepository<OrderDetailRecord> orderDetailRepository)
        {
